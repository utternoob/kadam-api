...
var accountsModel = require('../db/accountsModel');
...
//fetch all
app.get("/fetch/users/all", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, error_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 2, , 3]);
                _b = (_a = res).send;
                return [4 /*yield*/, accountsModel.find()];
            case 1:
                _b.apply(_a, [_c.sent()]);
                return [3 /*break*/, 3];
            case 2:
...
//add transaction
app.post("/user/update/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, accounts, amount, balance, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
...
//remove user account
app.delete("/user/delete/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
